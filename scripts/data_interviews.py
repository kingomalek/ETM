...
def clean_text(text):
    text = text.replace('A:','').replace('Q:','')
    tokenized_text = word_tokenize(text.lower())
    cleaned_text = [t for t in tokenized_text if t not in stops ]
...
# Save path
path_save = '../embeddings//min_df_' + str(min_df)+'_max_df_'+ str(max_df)+'/'
...
data_file = '/home/malek/work/insight_engine/data/all_interviews.txt'
docs = open(data_file,'r',encoding='utf-8').readlines()
